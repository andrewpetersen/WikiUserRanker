...
#key = 'trwiki-latest-pages-articles-multistream.xml'
appName = "Petersen_XML_S3_Postgres_Testing"

if __name__ == "__main__":
    tTotal = perf_counter()
    # Deal with input arguments, if any
...
#    ])
    ...
    # Clean user information, add 2 columns: cleanContributor, isRegistered
    ...
    StructStringTime = tStructStringEnd - tStructString
    ...
    print("StructStringTime: ",StructStringTime)
